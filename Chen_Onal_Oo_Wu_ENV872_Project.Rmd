...
Has electrcity consumption increased with GDP growth during the period from 1999 to 2022 in Turkiye?

## Question 2: 
Have electrcity consumption increased with investment and population growth during the period from 1999 to 2022 in Turkiye?
...
if (file.exists(data_path)) {
  ...
  growth_data <- data[, c("GDPgro", "Popgro", "Invgro", "Electirictygro")]
...
lm_model <- lm(GDPgro ~ Popgro + Invgro + Electirictygro, data=data)
...
#Conclusion for Question3:
 In this plot, while most points are within acceptable bounds, a few points significantly exceed the threshold, indicating they are outliers with substantial influence on the model. These should be investigated further to determine if they are anomalies or if they represent a valid but rare variation within the data. The conclusion is that the identified influential points merit closer examination to ensure the robustness and validity of the regression analysis.
