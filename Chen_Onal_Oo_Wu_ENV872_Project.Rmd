...
In the eight plot, a graphical representation of a correlation matrix using circles or ellipses. The size of each circle represents the magnitude of the correlation coefficient between two variables. Larger circles indicate stronger correlations, while smaller circles indicate weaker correlations. The color of each circle represents the sign of the correlation coefficient. Red shows positive correlations and blue shows negative correlation. There is a strong and positive raltionship between GDP growth, investment growth and electricity consumption growth. There is no positive relationship between population and Gdp growth as Solow-Swan model claimed. There is also no relationship between population growth-ivestment and population-electricity consumption.
...
#Ye please fix this:
#plot(ts_GDPdata.decomp, main = "GDP Growth Over Time", xlab = "Years", ylab = "GDP Growth")
#plot(ts_Invdata.decomp, main = "Investment Growth Over Time", xlab = "Years", ylab = "Investment growth")
#plot(ts_Popdata.decomp, main = "Population Growth Over Time", xlab = "Years", ylab = "Population growth")
#plot(ts_Elecdata.decomp, main = "Electricity Consumption Growth Over Time", xlab = "Years", ylab = "electricity consumption growth")

```
##we need to move it to somewhere else later
...
```
#we need to move those to the first part 
...
##Fei can move this to upper background info
...
```{r regression analysis, tidy=TRUE, error=FALSE}
...
#Question3:Ye please review this
